...
input='/home/nastia/Desktop/fasta_end.txt'
file_a=open(ina,'r')
#stra=file_a.readline()
#output=open('/home/nastia/Desktop/python_ptograms/dna/dna/test.txt','w')
#while len(stra)>0:
 #   output.write(stra[25:26]+'\n')
  #  stra=file_a.readline()
#file_a.close()
#output.close()
t=50
...
while len(strsm)>0:
    ...
    p=len(strs)-1
    #print(str(p+'   '+st))
    #if strs.find('aaa')==-1 and strs.find('ccc')==-1 and strs.find('ggg')==-1 and strs.find('ttt')==-1:
    out1='/home/nastia/Desktop/python_ptograms/dna/dna_pdb/'+strsm[0:q] +'1.pdb'
    out2='/home/nastia/Desktop/python_ptograms/dna/dna_pdb/'+strsm[0:q] +'2.pdb'
    out='/home/nastia/Desktop/python_ptograms/dna/dna_pdb/finish/'+strsm[0:q] +'.pdb'
    output1=open(out1,'w')
    output2=open(out2,'w')
